...
q = """ select * from staff where Department='Mechanical'"""
cur.execute(q)
r = cur.fetchall()
...
<body style="height:auto;">
    ...
    <section >
        <div class="container-fluid d-flex justify-content-center tble"style="min-height:780px;">
...
for i in r:
    print("""
        <tr>
            ...
            <td style="text-align:center;"><a href="edit.py?id=%s" class="edit">Edit</a></td>
            <td style="text-align:center;"><a href="deleteStaff.py?id=%s" class="delete">Delete</a></td>
        </tr>
     """ % (i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], i[8], "files/" + i[9], i[0], i[0]))
print("""
     </table>
 """)
print("""
