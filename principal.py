...
<body style="height:auto;">
 ...
 <!-- principal section -->
  ...
  <section class="principal" style="padding-top:175px">
        <div class="container2 mt-5 mb-5">
            <div class="row">
                <div class="col-12">
                    <div class="center">
                        <img src="images/Dr.Gomathi.jpg" class="img-fluid" width="270px" height="270px" style="border-radius:50%;">
                        <h2 class="mt-4 mb-4 text-center" >MESSAGE FROM PRINCIPAL&#39;S DESK</h2>
                        <p>
                           <em> Greetings! I am delighted to welcome you to the Study World College of Engineering website;
                             I hope to convey the passion and enthusiasm of both staff and students bring to you, 
                             and all that they do here to make Study World-The World &#39;s Education, a best place to learn.<br><br>

                             Born out of the vision of our founder, Dr. Vidhya Vinod started the Study World group in 2005,
                              and growing steadily on a global scale providing students worldwide with education of international standards.
                               Study World College of Engineering (SWCE) is one of the reputed private institutions of higher education located 
                               in Coimbatore, India, offering a popular range of AICTE approved and Anna University affiliated courses. 
                               Study World College is a part of Study World Education Holding Group with its headquarters in Dubai,
                                United Arab Emirates. It is found that the group has achieved so many golden feathers to its crown during the past years. 
                                The efforts taken by the management, faculty, staff and students to reach the Himalayan success are highly commendable.
                                 As the captain of SWCE, I am proud to be the part of the achievements of the institution. 
                                 Our campus is located in a serene suburban area of Coimbatore which allows our budding engineers to focus their attention completely on studies,
                                  creativity and innovation. We focus on all our students, who come from diverse backgrounds. We provide with the broadest possible
                                   scope and opportunity for academic exploration and nurture our students with special qualities like leadership,
                                    organizational skills and the ability to manage diverse options. In addition, towards the excellence, 
                                    SWCE keeps its clear mission to contribute to society through the pursuit of education and research at the highest 
                                    international levels of excellence.<br><br>
                                    I wish our students a very happy and academically rewarding student life at SWCE and hope that you will enhance
                                     the pride and prestige of our institution.
                                     </em><br><br>
                                     <strong>
                                        Study World-The World &#39;s Education-A life changing, intellectually challenging, career enhancing
                                         experience.<br>
                                         Begin your way to success-Discover your dreams at SWCE
                                     </strong><br><br>
                                     <strong>
                                        <i><h2>Dr.P.Gomathi ME PhD</h2></i>
                                         <h5 class="text-dark mt-3">Principal, SWCE</h5>
                                     </strong>
                        </p>
                    </div>
