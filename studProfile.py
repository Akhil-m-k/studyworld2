...
f = cgi.FieldStorage()
pid = f.getvalue("id")
q = """ select * from stud where id='%s'""" % (pid)
cur.execute(q)
r = cur.fetchall()
...
for i in r:
    ...
    <table >
      ...
      <tr>
      <td rowspan="10" style="width:400px; border:none;"><img src="%s" height="700px" width="500px" style="object-fit:cover;"></td>
        <th>Name </th>
        <td>%s</td>
      </tr>
      <tr>
    ...
    """ % ("files/" + i[11], i[1], i[2], i[3], i[4], i[5], i[6],i[7],i[8],i[9],i[10]))
    print("""
  </table>
  """)
