            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                 <form method="post" action="">
                    ...
                    <input type="text" placeholder="enter new password" name="password" id="password"><br>
                    <label for="re-password">Re-Enter password</label><br>
                    <input type="text" placeholder="Re-enter your password" name="re-password" id="re-password"><br>
...
prepass = f.getvalue("re-password")
psub = f.getvalue("sub")
...
if psub != None:
    ...
    cur = conn.cursor()
    if ppass==prepass:
        q=""" update staff set password='%s'"""%(ppass)
        cur.execute(q)
        conn.commit()
        print("""
               <script>
                   alert("password is successfully edited..!!!");
                   location.href="staffLogin.py"
               </script>
           """)
    else:
        print("""
