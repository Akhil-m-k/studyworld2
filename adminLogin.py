...
<body style="height:auto;">
    ...
    <section style="background-color:#09347a; min-height:50px; margin-top:-10px;">
        <h1 style="color:#fff;  font-size:40px;  font-weight:bold; ">STUDY WORLD COLLEGE OF ENGINEERING</h1>
    </section>
    <section class="login ">
        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <h1>Login</h1>
                <label for="a-id">Admin Id</label><br>
                <input type="text" placeholder="enter your id" name="a-id" id="a-id"><br>
...
if psub != None:
    ...
    cur = conn.cursor()
    q = """ select id,adminId,password from Admin where adminId='%s' and password='%s'"""%(pa_id, ppass)
    cur.execute(q)
    f = cur.fetchone()
