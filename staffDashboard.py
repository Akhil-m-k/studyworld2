...
f = cgi.FieldStorage()
pid = f.getvalue("id")
q = """ select staffName,profile from staff WHERE id='%s'"""%(pid)
cur.execute(q)
r = cur.fetchone()
print("""
<!DOCTYPE html>
...
<body style="height:auto;">
            ...
            <div class="container-lg container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                 ...
                 <li>
                    <div class="dropdown">
                          <button class="dropbtn" >Student Leave
                            <i class="fa-solid fa-caret-down icon-1"></i>
                            <i class="fa-sharp fa-solid fa-caret-up icon-2" ></i>
                          </button>
                          <div class="dropdown-content" >
                            <a href="newLeaveStud.py">New</a>
                            <a href="existingLeaveStud.py">Existing</a>
                         </div>
                    </div>
                 </li>
                ...
                <li>
                      <div class="dropdown">
                        <a  href="staffProfile.py?id=%s"><img src="%s" height="50px" class="ms-5 me-5 " width="50px" style="border-radius:50px; border:2px solid blue;"></a>                    
                      <div class="logout"  border-radius:10px;">
                        <div class="arrow"></div>
                        <a style="color:#fff;">view full profile</a>
                      </div>
                    </div>
    ...
    <section class="login" style="min-height:800px;">
        <div class="container-fluid">
            <div class="row">
...
function logout() {
  ...
  window.location.replace("staffLogin.py");
  return false;
}
</script>
    </body>
    </html>
"""%(pid,pid,pid,"files/"+r[1],r[0]))
