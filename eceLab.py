...
<body style="height:auto;">
    ...
    <section class="content" style="padding-top:165px; min-height:600px;">
       ...
       <div class="container pt-4 pb-4">
            <div class="row">
                <div class="col-12">
                    <h2>Lab and Facilities</h2>
                    <h4>Laboratories/Workshops:</h4>
                    <h4>Electronic Devices and Circuits Lab</h4>
                    <ul>
                        ...
                        <li>Analog Integrated Circuits Lab</li>
                    ...
                    <ul>
                        <li>
                            The specialization of the faculty members includes communication system engineering, 
                            VLSI, applied electronics, wireless communication and embedded system.
                        </li>
                        <li>
                            The Laboratories are equipped with high end equipments like DSP processors,
                             FPGA kit, Microwave Benches, Optical Fiber kits, ,SDR Dongle ,Digital Trainer
                              Kit ,Advanced communication kits, DSO, Microprocessor &Micro Controller kits,
                               and latest software packages like MATLAB,LT SPICE, XILINX, PROTEUS,MultiSim,
                                Lab VIEW, Python and Code Composer Studio to impart hands on experience and
                                 training in the latest technology to complement their theoretical knowledge.
                        </li>
                        <li>
