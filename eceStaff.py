        ...
        <hr>
            <div class="row  pt-4 pb-5" style="row-gap:20px;">
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/Bivin.jpg"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Dr. BIVIN RAJ </h4>
                    <h6 class="text-center"> professor</h6>
                    <h6 class="text-center">POWER CONTROL AND DRIVES</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/nandhana.png"class="img-fluid " style="height:320px;" >
                    <h4 class="text-center pt-3">Ms.NANDHANA</h4>
                    <h6 class="text-center">Associate Professor</h6>
                    <h6 class="text-center">COMPUTER AND INFORMATION SCIENCE</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/anusree.png"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Ms. ANUSREE </h4>
                    <h6 class="text-center">Associate Professor</h6>
                    <h6 class="text-center">WIRELESS COMMUNICATION</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/safvan2.jpg"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Mr. SAFVAN MK </h4>
                    <h6 class="text-center">Associate Professor</h6>
                    <h6 class="text-center">VLSI DESIGN</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/shijo.png"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Mr. SHIJOTHOMAS</h4>
                    <h6 class="text-center">Associate Professor</h6>
                    <h6 class="text-center">APPLIED ELECTRONICS</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/Andrew.jpg"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Mr. ANDREW AGUSTIN</h4>
                    <h6 class="text-center">Assistant Professor</h6>
                    <h6 class="text-center">APPLIED ELECTRONICS</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/danaya.png"class="img-fluid" style=" height:320px;" >
                    <h4 class="text-center pt-3">Ms. DANAYA</h4>
                    <h6 class="text-center">Assistant Professor</h6>
                    <h6 class="text-center">APPLIED ELECTRONICS</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/Kavya.png"class="img-fluid " style=" height:320px;" >
                    <h4 class="text-center pt-3">Ms. KAVYA</h4>
                    <h6 class="text-center">Assistant Professor</h6>
                    <h6 class="text-center">ELECTRONICS AND COMMUNICATION ENGINEERING</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <img src="images/anas.png"class="img-fluid " style="height:320px;" >
                    <h4 class="text-center pt-3">Mr. ANAS N</h4>
                    <h6 class="text-center">Assistant Professor</h6>
                    <h6 class="text-center">APPLIED ELECTRONICS</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                     <img src="images/vaisakh.jpg"class="img-fluid  " style=" height:320px;" >
                    <h4 class="text-center pt-3">Mr. VAISAKH A</h4>
                    <h6 class="text-center">Assistant Professor</h6>
                    <h6 class="text-center">ELECTRONICS AND COMMUNICATION ENGINEERING</h6>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
