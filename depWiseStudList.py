...
pdep = f.getvalue("dep")
psem = f.getvalue("sem")
q = """ select * from stud where  Department='%s' and Semester='%s'"""%(pdep,psem)
cur.execute(q)
r = cur.fetchall()
...
<body style="height:auto;">
    ...
    <section >
        <div class="container-fluid d-flex justify-content-center tble" style="min-height:600px;">
...
for i in r:
    print("""
        <tr>
            ...
            <td>%s</td>
            <td>%s</td>
            <td><img src="%s" height="50px"width="50px"style="border-radius:50px;"></td>
            <td style="text-align:center;"><a href="studEdit.py?id=%s" class="edit">Edit</a></td>
            <td style="text-align:center;"><a href="deleteStaff.py?id=%s" class="delete">Delete</a></td>
        </tr>
     """ % (i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], i[8], i[9], i[10], "files/" + i[11], i[0], i[0]))
print("""
     </table>
 """)
print("""
