            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul>
                        ...
                        <li>Hydraulics and Fluid Machinery Lab</li>
                    ...
                    <ul>
                        <li>
                            Apart from providing theoretical cognizance in the field of Robotics,
                            we have a full fledged Robotics Lab with 6-axis Robotic arm and other CNC machines.
                        </li>
                        <li>
                           The specialization of the faculty members includes CAD/CAM, Aeronautical Engineering,
                           Production Engineering, Thermal Engineering, Farm Power Machinery and Energy,
                           Engineering Design and Manufacturing Engineering.
                        </li>
                        <li>
                            Our mechanical CAD Lab is equipped with state of the art design packages 
                            like Solidworks, CATIA, Unigraphics, IDEAS, SIMULIA, ProE, Nastran and 
                            Patran apart from basic packages like Autocad and ANSYS.
                        </li>
                    </ul>
                </div>
            </div>
