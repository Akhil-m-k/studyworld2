...
<body style="height:auto;">
                  ...
                  <li>
                    <div class="dropdown">
                          ...
                          <div class="dropdown-content">
                            ...
                            <a href="ECE.py">Electronics and Communication</a>
                            <a href="EEE.py">Electrical and Electronics</a>
                            <a href="ME.py">Mechanical</a>
                            <a href="CE.py">Civil</a>
                         </div>
                    </div>
                 </li>
                 <li>
                    <div class="dropdown">
                          ...
                          <div class="dropdown-content" >
                            ...
                            <a href="depWiseStud.py">Department Wise</a>
                         </div>
                    </div>
                </li>
                <li>
    ...
    <section class="login"style="overflow: hidden;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 animate container" >
                <h1 >STUDY WORLD COLLEGE OF ENGINEERING</h1>
                      <div class="main">
                            ...
                            <div class="option   text-center" >
                                ...
                                <li><span class="span1 ">ADMIN....!!!!</span></li>
