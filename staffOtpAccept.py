...
f= cgi.FieldStorage()
pid= f.getvalue("id")
gen_otp =f.getvalue("generate_OTP")
print("""
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                 <form method="post" action="">
                    <h1>Login</h1>
                    <label for="otp2">OTP</label><br>
                    <input type="text" placeholder="enter your otp" name="otp3" id="otp3"><br>
...
if psub != None:
    ...
    if gen_otp==potp:
        print("""
               <script>
                   location.href="staffReEnterPass.py?id=%s";
               </script>
           """%(pid))
    else:
        print("""
