...
f = cgi.FieldStorage()
pid = f.getvalue("id")
q=""" select studName,profile from stud where id='%s'"""%(pid)
cur.execute(q)
r = cur.fetchone()
print("""
<!DOCTYPE html>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-lg container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <li>
                      <div class="dropdown">
                        <a  href="studProfile.py?id=%s"><img src="%s" height="50px" class="ms-5 me-5 " width="50px" style="border-radius:50px; border:2px solid blue;"></a>                    
